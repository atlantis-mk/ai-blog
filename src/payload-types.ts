...
export interface Post {
  ...
  aiDocument?: {
    kind?: ('runbook' | 'reference' | 'checklist') | null;
    status?: ('draft' | 'reviewed' | 'verified') | null;
    version?: string | null;
    /**
     * 例如：Payload 3.86、Node.js 22、SQLite。
     */
...
export interface Release {
  ...
  /**
   * 例如：Apple Silicon / Intel / Universal
   */
  architecture?: string | null;
  systemRequirements?: string | null;
  checksumAlgorithm?: ('sha256' | 'sha512' | 'md5') | null;
